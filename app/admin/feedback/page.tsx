...
import { getFeedbackPosts } from "@/lib/data";

export const metadata: Metadata = {
  title: "Manage Feedback — Roadmap Nexus",
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="mt-1 text-[#5c6878]">Review and moderate user feedback.</p>
      </div>
            ...
            {posts.map((post) => (
              <tr key={post.id} className="transition hover:bg-[#fafbfc]">
                ...
                <td className="px-4 py-3">
                  <span
                    className={`inline-block rounded-full px-2.5 py-0.5 text-xs font-semibold ${statusStyles[post.status] || ""}`}
                  >
